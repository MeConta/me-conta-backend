...
export class modeloInicial1628875021720 implements MigrationInterface {
    name = 'modeloInicial1628875021720'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "supervisor" ("id" SERIAL NOT NULL, "dataCriacao" TIMESTAMP NOT NULL DEFAULT now(), "dataAlteracao" TIMESTAMP NOT NULL DEFAULT now(), "dataExclusao" TIMESTAMP, "especializacao" character varying NOT NULL, "descricao" character varying NOT NULL, "instituicao" character varying NOT NULL, "aprovado" boolean NOT NULL, "areaAtuacao" character varying NOT NULL, "crp" character varying NOT NULL, CONSTRAINT "PK_6364b1ffaa6ca051de919c802ed" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "atendente" ("id" SERIAL NOT NULL, "dataCriacao" TIMESTAMP NOT NULL DEFAULT now(), "dataAlteracao" TIMESTAMP NOT NULL DEFAULT now(), "dataExclusao" TIMESTAMP, "especializacao" character varying NOT NULL, "descricao" character varying NOT NULL, "instituicao" character varying NOT NULL, "aprovado" boolean NOT NULL, "formado" boolean NOT NULL, "semestre" integer, "anoFormacao" integer, "usuarioId" integer NOT NULL, "supervisorId" integer, CONSTRAINT "REL_2727edd094237a1c1a1a6ebcd3" UNIQUE ("usuarioId"), CONSTRAINT "REL_d8c571bdd53b0db10e5405bc5d" UNIQUE ("supervisorId"), CONSTRAINT "PK_695420d3280fdd5b0270622775f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "consulta" ("id" SERIAL NOT NULL, "dataCriacao" TIMESTAMP NOT NULL DEFAULT now(), "dataAlteracao" TIMESTAMP NOT NULL DEFAULT now(), "dataExclusao" TIMESTAMP, "atendenteId" integer, "alunoId" integer, "agendaId" integer, CONSTRAINT "REL_6b678cfda2b959923a91de5d9a" UNIQUE ("atendenteId"), CONSTRAINT "REL_4031e5f37ca2454252328df45a" UNIQUE ("alunoId"), CONSTRAINT "REL_9ba0fd5a307d333a3330e45a0d" UNIQUE ("agendaId"), CONSTRAINT "PK_248230d7f1e2536f83b4d07c955" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "agenda" ("id" SERIAL NOT NULL, "dataCriacao" TIMESTAMP NOT NULL DEFAULT now(), "dataAlteracao" TIMESTAMP NOT NULL DEFAULT now(), "dataExclusao" TIMESTAMP, "data" TIMESTAMP NOT NULL, "atendenteId" integer, CONSTRAINT "REL_5f1654821006a11534e34a02f7" UNIQUE ("atendenteId"), CONSTRAINT "PK_49397cfc20589bebaac8b43251d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "consulta" ADD CONSTRAINT "FK_6b678cfda2b959923a91de5d9a0" FOREIGN KEY ("atendenteId") REFERENCES "atendente"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "consulta" DROP CONSTRAINT "FK_6b678cfda2b959923a91de5d9a0"`);
