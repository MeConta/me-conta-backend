...
export class modeloInicial1630590848297 implements MigrationInterface {
    name = 'modeloInicial1630590848297'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "supervisor" ("id" SERIAL NOT NULL, "dataCriacao" TIMESTAMP NOT NULL DEFAULT now(), "dataAlteracao" TIMESTAMP NOT NULL DEFAULT now(), "dataExclusao" TIMESTAMP, "especializacao" character varying, "crp" character varying, "descricao" character varying NOT NULL, "instituicao" character varying NOT NULL, "aprovado" boolean, "areaAtuacao" character varying NOT NULL, "usuarioId" integer, CONSTRAINT "REL_dbf714549b6687c483773e1402" UNIQUE ("usuarioId"), CONSTRAINT "PK_6364b1ffaa6ca051de919c802ed" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "atendente" ("id" SERIAL NOT NULL, "dataCriacao" TIMESTAMP NOT NULL DEFAULT now(), "dataAlteracao" TIMESTAMP NOT NULL DEFAULT now(), "dataExclusao" TIMESTAMP, "especializacao" character varying, "crp" character varying, "descricao" character varying NOT NULL, "instituicao" character varying NOT NULL, "aprovado" boolean, "formado" boolean NOT NULL, "semestre" integer, "anoConclusao" integer, "usuarioId" integer, "supervisorId" integer, CONSTRAINT "REL_2727edd094237a1c1a1a6ebcd3" UNIQUE ("usuarioId"), CONSTRAINT "REL_d8c571bdd53b0db10e5405bc5d" UNIQUE ("supervisorId"), CONSTRAINT "PK_695420d3280fdd5b0270622775f" PRIMARY KEY ("id"))`);
